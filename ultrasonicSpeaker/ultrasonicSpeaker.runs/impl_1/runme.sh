...
HD_PWD='C:/Users/semenov/Desktop/fpga_speaker_project/ultrasonicSpeaker/ultrasonicSpeaker.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UltrasonicSpeaker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UltrasonicSpeaker.tcl -notrace
