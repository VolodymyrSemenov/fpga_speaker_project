...
HD_PWD='C:/Users/semenov/Desktop/speaker_project/ultrasonicSpeaker/ultrasonicSpeaker.runs/combined_clock_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combined_clock_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combined_clock_gen.tcl
