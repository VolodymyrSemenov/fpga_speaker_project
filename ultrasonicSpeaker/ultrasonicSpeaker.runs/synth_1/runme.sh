...
HD_PWD='C:/Users/semenov/Desktop/fpga_speaker_project/ultrasonicSpeaker/ultrasonicSpeaker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UltrasonicSpeaker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UltrasonicSpeaker.tcl
