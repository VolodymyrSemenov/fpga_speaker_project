...
#
# Script generated by Vivado on Sat Nov 16 14:42:51 -0500 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : combined_clock_gen.sh
...
#
# Usage        : combined_clock_gen.sh
#                combined_clock_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                combined_clock_gen.sh [-reset_run]
#                combined_clock_gen.sh [-reset_log]
#                combined_clock_gen.sh [-help]
#
...
# script info
echo -e "combined_clock_gen.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./combined_clock_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot combined_clock_gen xil_defaultlib.combined_clock_gen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim combined_clock_gen -key {Behavioral:sim_1:Functional:combined_clock_gen} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb combined_clock_gen.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./combined_clock_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: combined_clock_gen.sh [-help]\n\
Usage: combined_clock_gen.sh [-step]\n\
Usage: combined_clock_gen.sh [-lib_map_path]\n\
Usage: combined_clock_gen.sh [-reset_run]\n\
Usage: combined_clock_gen.sh [-reset_log]\n\
Usage: combined_clock_gen.sh [-keep_index]\n\
Usage: combined_clock_gen.sh [-noclean_files]\n\n\
