...
#                script (type 'combined_clock_gen.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.combined_clock_gen xil_defaultlib.glbl -o combined_clock_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./combined_clock_gen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key combined_clock_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc combined_clock_gen_simv.daidir vcs_lib c.obj)
